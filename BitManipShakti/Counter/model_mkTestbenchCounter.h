...
#ifndef __model_mkTestbenchCounter_h__
#define __model_mkTestbenchCounter_h__
...
/* Class declaration for a model of mkTestbenchCounter */
class MODEL_mkTestbenchCounter : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTestbenchCounter *mkTestbenchCounter_instance;
...
#endif /* ifndef __model_mkTestbenchCounter_h__ */
